...
var centerMenu = [
    ...
    ,{
        name: '酒店收藏',
        url: '../jiudianCollection/list.html'
    }
    ,{
        name: '酒店预定',
        url: '../jiudianYuyue/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/qcybwenhualvyou/admin/dist/index.html#/login";
