    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">七彩云南文化旅游网站注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="导游姓名" class="input" v-if="tableName=='daoyou'">
                            <el-input v-model="ruleForm.daoyouName" autocomplete="off" placeholder="导游姓名"  />
                        </el-form-item>
                        <!--
                            <el-form-item v-if="daoyouPhotoFlag">
                            </el-form-item>
                            <el-form-item label="头像" class="input" v-if="tableName=='daoyou'">
                                    <file-upload
                                        tip="点击上传头像"
                                        action="file/upload"
                                        :limit="1"
                                        :multiple="true"
                                        :fileUrls="ruleForm.daoyouPhoto?$base.url+ruleForm.daoyouPhoto:''"
                                        @change="daoyouPhotoUploadChange"
                                    ></file-upload>
                           </el-form-item>
                        -->
                        <el-form-item label="联系方式" class="input" v-if="tableName=='daoyou'">
                            <el-input v-model="ruleForm.daoyouPhone" autocomplete="off" placeholder="联系方式"  />
                        </el-form-item>
                        <el-form-item label="邮箱" class="input" v-if="tableName=='daoyou'">
                            <el-input v-model="ruleForm.daoyouEmail" autocomplete="off" placeholder="邮箱"  />
                        </el-form-item>
                        <!--
                            <el-form-item label="假删" class="input" v-if="tableName=='daoyou'">
                                <el-input v-model="ruleForm.daoyouDelete" autocomplete="off" placeholder="假删"  />
                           </el-form-item>
                        -->
                        <!--
                            <el-form-item label="创建时间" class="input" v-if="tableName=='daoyou'">
                                <el-input v-model="ruleForm.createTime" autocomplete="off" placeholder="创建时间"  />
                           </el-form-item>
                        -->
                        <el-form-item label="游客姓名" class="input" v-if="tableName=='yonghu'">
                            <el-input v-model="ruleForm.yonghuName" autocomplete="off" placeholder="游客姓名"  />
                        </el-form-item>
                        <!--
    ...
    export default {
        data() {
            return {
                ...
                rules: {},
                sexTypesOptions : [],
                daoyouPhotoFlag:false,//用于刷新文件上传
        ...
        methods: {
            ...
            daoyouPhotoUploadChange(fileUrls) {
               this.ruleForm.daoyouPhoto = fileUrls;
                if(this.daoyouPhotoFlag){
                    this.daoyouPhotoFlag=false;
                }else{
                    this.daoyouPhotoFlag=true;
                }
            },
            ...
            login() {
                            ...
                            if((!this.ruleForm.daoyouName)&& 'daoyou'==this.tableName){
                                this.$message.error('导游姓名不能为空');
                                return
                            }
                            // daoyou 中的 头像 判空处理
                            // if('daoyou' == this.tableName && (this.ruleForm.daoyouPhoto== null ||this.ruleForm.daoyouPhoto== "")){
                            //     this.$message.error("头像不能为空");
                            //     return
                            // }
                             if('daoyou' == this.tableName && this.ruleForm.daoyouPhone&&(!this.$validate.isMobile(this.ruleForm.daoyouPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if('daoyou' == this.tableName && this.ruleForm.daoyouEmail&&(!this.$validate.isEmail(this.ruleForm.daoyouEmail))){
                                this.$message.error("邮箱应输入邮件格式");
                                return
                            }
                            // daoyou 中的 假删 判空处理
                            // if('daoyou' == this.tableName && (this.ruleForm.daoyouDelete== null ||this.ruleForm.daoyouDelete== "")){
                            //     this.$message.error("假删不能为空");
                            //     return
                            // }
                            // daoyou 中的 创建时间 判空处理
                            // if('daoyou' == this.tableName && (this.ruleForm.createTime== null ||this.ruleForm.createTime== "")){
...
.container {
    ...
    background-repeat: no-repeat;
        background-image: url(/qcybwenhualvyou/img/back-img-bg.jpg);
