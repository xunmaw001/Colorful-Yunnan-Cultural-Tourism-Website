                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/qcybwenhualvyou/upload/jingdianLiuyanMuBan.xls"
                        >批量导入旅游景点留言数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('jingdianLiuyan','导入导出')"
        ...
        methods: {
            ...
            wuyong(id) {
                ...
                _this.$confirm(`确定    操作?`, "提示", {confirmButtonText: "确定",cancelButtonText: "取消",type: "warning"
                    ...
                    _this.$http({
                        url: "jingdianLiuyan/update",
                        method: "post",
                        data: {
                            id:id,
//                            jingdianLiuyanTypes:jingdianLiuyanTypes,
                        }
                    }).then(({data}) => {
                        if(data && data.code === 0){
