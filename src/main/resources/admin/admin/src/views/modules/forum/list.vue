...
|| (sessionTable == 'daoyou' && scope.row.daoyouId ==userId)
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/qcybwenhualvyou/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.daoyouId = el.daoyouId;//---
                            forum.daoyouName = el.daoyouName;
                            forum.daoyouPhoto = el.daoyouPhoto;
                            forum.daoyouPhone = el.daoyouPhone;
                            forum.daoyouEmail = el.daoyouEmail;
                            forum.daoyouDelete = el.daoyouDelete;
                            forum.createTime = el.createTime;
