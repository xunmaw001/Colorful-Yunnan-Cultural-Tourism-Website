...
public class JingdianLiuyanController {
    ...
    private static final String TABLE_NAME = "jingdianLiuyan";
    ...
    */
    ...
    public R update(@RequestBody JingdianLiuyanEntity jingdianLiuyan, HttpServletRequest request) throws NoSuchFieldException, ClassNotFoundException, IllegalAccessException, InstantiationException {
        logger.debug("update方法:,,Controller:{},,jingdianLiuyan:{}",this.getClass().getName(),jingdianLiuyan.toString());
        JingdianLiuyanEntity oldJingdianLiuyanEntity = jingdianLiuyanService.selectById(jingdianLiuyan.getId());//查询原先数据
...
//            jingdianLiuyan.setYonghuId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        List<JingdianLiuyanEntity> oldJingdianLiuyanList =jingdianLiuyanService.selectBatchIds(Arrays.asList(ids));//要删除的数据
...
//                            jingdianLiuyanEntity.setJingdianId(Integer.valueOf(data.get(0)));   //旅游景点 要改的
//                            jingdianLiuyanEntity.setYonghuId(Integer.valueOf(data.get(0)));   //游客 要改的
