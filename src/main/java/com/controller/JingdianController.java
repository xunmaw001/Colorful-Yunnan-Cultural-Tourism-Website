...
//                            jingdianEntity.setJingdianMoney(data.get(0));                    //价格/人 要改的
//                            jingdianEntity.setJingdianClicknum(Integer.valueOf(data.get(0)));   //热度 要改的
//                            jingdianEntity.setZanNumber(Integer.valueOf(data.get(0)));   //赞 要改的
//                            jingdianEntity.setcaiNumber(Integer.valueOf(data.get(0)));   //踩 要改的
//                            jingdianEntity.setJingdianText(data.get(0));                    //日程路线 要改的
...
//                            jingdianEntity.setCreateTime(date);//时间
                        ...
                        //查询是否重复
                         //景点编号
                        List<JingdianEntity> jingdianEntities_jingdianUuidNumber = jingdianService.selectList(new EntityWrapper<JingdianEntity>().in("jingdian_uuid_number", seachFields.get("jingdianUuidNumber")));
    ...
    */
    ...
    public R gexingtuijian(@RequestParam Map<String, Object> params, HttpServletRequest request){
        ...
        PageUtils pageUtils = jingdianCollectionService.queryPage(params1);
        List<JingdianCollectionView> collectionViewsList =(List<JingdianCollectionView>)pageUtils.getList();
        Map<Integer,Integer> typeMap=new HashMap<>();//购买的类型list
        for(JingdianCollectionView collectionView:collectionViewsList){
            Integer jingdianTypes = collectionView.getJingdianTypes();
    ...
    */
    ...
    public R add(@RequestBody JingdianEntity jingdian, HttpServletRequest request){
        ...
        Wrapper<JingdianEntity> queryWrapper = new EntityWrapper<JingdianEntity>()
            ...
            .eq("zan_number", jingdian.getZanNumber())
            .eq("cai_number", jingdian.getcaiNumber())
            .eq("jingdian_text", jingdian.getJingdianText())
