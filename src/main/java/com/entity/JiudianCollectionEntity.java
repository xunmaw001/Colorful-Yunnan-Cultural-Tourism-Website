...
public class JiudianCollectionEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JiudianCollectionEntity() {

	}

	public JiudianCollectionEntity(T t) {
		try {
    ...
    @TableField(value = "jiudian_collection_types")
