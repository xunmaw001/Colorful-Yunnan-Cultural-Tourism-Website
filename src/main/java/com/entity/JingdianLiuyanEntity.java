...
public class JingdianLiuyanEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JingdianLiuyanEntity() {

	}

	public JingdianLiuyanEntity(T t) {
		try {
    ...
    @TableField(value = "jingdian_liuyan_text")
    ...
    public String toString() {
        return "JingdianLiuyan{" +
            ", id=" + id +
            ", jingdianId=" + jingdianId +
            ", yonghuId=" + yonghuId +
            ", jingdianLiuyanText=" + jingdianLiuyanText +
